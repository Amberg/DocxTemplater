    ...
    class GitHubQuestionsExamples
    {
        ...
        public void EachItemOnNewLine()
        {
            ...
            Assert.That(body.InnerXml,
                Is.EqualTo(@"<w:p xmlns:w=""http://schemas.openxmlformats.org/wordprocessingml/2006/main""><w:r><w:t>First Line</w:t><w:br /><w:t>Second Line</w:t><w:br /><w:t>Third Line</w:t><w:br /></w:r></w:p>"));
        }
    }
}
